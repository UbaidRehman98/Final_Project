...
import com.petx.petx.activity.AdoptAPetActivity;
import com.petx.petx.activity.DoneDealActivity;
import com.petx.petx.activity.PetDetailsActivity;
import com.petx.petx.activity.ProductEditActivity;
import com.petx.petx.activity.StoreActivity;
 ...
 * Use the {@link AdoptPetsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AdoptPetsFragment extends Fragment {
     ...
     * @return A new instance of fragment AdoptPetsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AdoptPetsFragment newInstance(String param1, String param2) {
        AdoptPetsFragment fragment = new AdoptPetsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_adopt_pets, container, false);
...
// Create the item click listener
        PetAdapter.OnItemClickListener itemClickListener = new PetAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Pet pet) {
                ...
                intent.putExtra("pet1", pet);
                intent.putExtra("updateOption",2);
...
// Create the PetAdapter and set the item click listener
        PetAdapter adapter = new PetAdapter(petList, itemClickListener,getActivity());
...
// Retrieve pet data from Firebase Realtime Database
        ...
        uploadPetButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (imageUri != null && !title.isEmpty() && !description.isEmpty() && petType != null) {
                    uploadPet(title, description, petType);
                } else {
    ...
    private void uploadPet(final String title, final String description, final String petType) {
        ...
        final String petId = mDatabase.child("adopt_pets").push().getKey();
                    ...
                    imageRef.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                Pet newPet = new Pet(petId, title, description, petType, downloadUri.toString(), userId);

                                // Save the new pet to the Firebase Realtime Database
                                mDatabase.child("adopt_pets").child(petId).setValue(newPet);
