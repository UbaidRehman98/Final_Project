...
public class PetBuyAdapter extends RecyclerView.Adapter<PetBuyAdapter.ViewHolder> {
    ...
    public PetBuyAdapter(List<Buy> petList, OnItemClickListener onItemClickListener, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_view_seals_pet, parent, false);
