...
public class AccessoriesBuyAdapter extends RecyclerView.Adapter<AccessoriesBuyAdapter.ViewHolder> {
    ...
    public AccessoriesBuyAdapter(List<Buy> petList, OnItemClickListener onItemClickListener, Context context) {
